...
function [BestSolACO,BestAnt,BestCostACO] = ACO(N,Max_Iteration,lb,ub,dim,fobj,mlpConfig)
disp('ACO is now tackling your problem');
...
rho = 0.9; % global pheromone decay rate, between 0 and 1
...
%         ant(k).Cost=CostFunction(ant(k).Tour);
       ant(k).Cost= fobj(ant(k).Tour,mlpConfig);
