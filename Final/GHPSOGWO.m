% Grey Wolf Optimizer
function [Alpha_score,Alpha_pos,Convergence_curve]=GHPSOGWO(SearchAgents_no,Max_iter,lb,ub,dim,fobj,mlpConfig)
disp('GHPSOGWO is now tackling your problem');
